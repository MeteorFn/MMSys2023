...
public:
                              ...
                              const std::vector<DataNumber> &dataids, Timepoint sendtic)
    {
        ...
        // Implementation
        totalRequestedCnt += dataids.size();
    }
    ...
    void DoAlarmTimeoutDetection()
    {
        ...
        {
            // Implementation
            totalLossCnt += loss.lossPackets.size();
    ...
    // Implementation
    double_t GetLossRate()
    {
        return totalLossCnt * 1.0 / totalRequestedCnt;
    }
...
private:
    ...
    // Implementation
    uint64_t totalRequestedCnt{0};
    uint64_t totalLossCnt{0};
    double_t lossRate{0};
